  ...
  <div class="login-box-body">
    ...
    <form  method="post">
      ...
      <div class="form-group has-feedback">
        <label>Email Address:{{  admin()->user()->email  }}
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span></label>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">ٍreset</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
